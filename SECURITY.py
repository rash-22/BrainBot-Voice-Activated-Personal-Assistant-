...
if __name__ == '__main__':
	...
	image1 = Image.open('extrafiles/images/img_2.png')
	...
	#welcome label
	welcLbl = Label(root1, text='Hi there,\nI am B.R.A.I.N.A.\nYour Personal virtual Assistant', font=('Arial Bold', 15), fg='#303E54', bg=background)
	...
	if os.path.exists('userData/trainer.yml')==False:
		loginStatus['text'] = 'Pls Register Your FACE'
		addFace = Button(root1, text='   Register Face   ', font=('Arial', 12), bg='#262e2e', fg='white', relief=FLAT, command=lambda:raise_frame(root2))
