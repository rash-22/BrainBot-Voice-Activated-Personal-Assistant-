...
def createFile(text):
#	appLocation = "C:\Users\Aryan\AppData\Local\Programs\Microsoft VS Code\Code.exe"
	if isContain(text, ["ppt","power point","powerpoint"]):
		file_name = "sample_file.ppt"
		appLocation = "C:\Program Files\Microsoft Office\Office15\POWERPNT.exe"

	elif isContain(text, ['excel','spreadsheet']):
		file_name = "sample_file.xsl"
		appLocation = "C:\Program Files\Microsoft Office\Office15\EXCEL.EXE"

	elif isContain(text, ['word','document']):
		file_name = "sample_file.docx"
		appLocation = "C:\Program Files\Microsoft Office\Office15\WINWORD.EXE"
